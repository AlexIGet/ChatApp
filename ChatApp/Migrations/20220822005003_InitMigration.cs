        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MainMessageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForwardMessages_Messages_MainMessageId",
                        column: x => x.MainMessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForwardMessages_Messages_RelatedMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForwardMessages_MainMessageId",
                table: "ForwardMessages",
                column: "MainMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_ForwardMessages_RelatedMessageId",
                table: "ForwardMessages",
